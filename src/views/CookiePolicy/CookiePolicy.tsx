    ...
    <main className="cookie-policy px-2">
      ...
      <section>
        ...
        <p>
          ...
          <a href="https://pjatk.zdaj.se">https://pjatk.zdaj.se</a> oraz{' '}
      ...
      <section>
        <TypographyH2 id="rodzaje-cookies">
        ...
        <p>
          Niezbędne pliki cookies obejmują ściśle niezbędne pliki cookies,
          których używamy do funkcjonowania Serwisu oraz funkcjonalne pliki
          cookie, które pomagają w działaniu i projektowaniu Serwisu. Ulepszają
          one funkcjonalność Serwisu, a także umożliwiają jej personalizację.
        </p>
        <p>
        ...
        <p>
          Możesz dostosować ustawienia przeglądarki w taki sposób by blokowała
          ona działanie tego rodzaju plików cookies. Pamiętaj, że jeżeli
          zdecydujesz się na takie rozwiązanie, to niektóre części Serwisu mogą
          nie działać.
        </p>
        ...
        <p>
          ...
          informację, które zakładki strony są najbardziej popularne, a także
          jak użytkownicy poruszają się po Serwisu. Pliki te mają na celu
          poprawić komfort korzystania z Serwisu. Dodatkowo, dzięki analitycznym
          plikom cookies mamy możliwość wykrywać różnego rodzaju nadużycia np.
          sztuczny ruch internetowy (boty).
        </p>
        <p>
          Na działanie analitycznych plików cookies niezbędna jest Twoja zgoda.
          Możesz dostosować ustawienia przeglądarki w taki sposób by blokowała
          ona działanie tego rodzaju plików cookies. Aby uzyskać więcej
          informacji na temat zarządzania swoimi plikami cookies (wyrażenia i
          wycofania zgody), przeczytaj pkt 5 niniejszej polityki.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          Administrator nie ponosi odpowiedzialności. Lista partnerów
      ...
      <section>
        <TypographyH2 id="wyłączenie-odpowiedzialności">
      ...
      <section>
        <TypographyH2 id="zmiany-w-polityce-cookie">
